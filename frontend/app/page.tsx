      ...
      <main className="flex-1 pt-20">
        <section className="relative px-6 py-24 md:py-32 overflow-hidden">
          ...
          <div className="max-w-5xl mx-auto text-center relative z-10">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-teal-50 border border-teal-100 text-teal-700 text-xs font-semibold mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-gray-900 mb-8 leading-tight animate-in fade-in slide-in-from-bottom-6 duration-700 delay-100">
              Health Answers, <br className="hidden md:block" />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-600 to-blue-600">Verified & Accessible.</span>
            </h1>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <p className="text-gray-400 text-lg leading-relaxed mb-8">
                  <strong>AskDokita</strong> helps close that gap by offering a friendly,
